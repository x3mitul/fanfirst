...
export default function EventDetailPage() {
    ...
    const handlePurchase = async () => {
        ...
        // Show quiz first if not completed
        if (!quizCompleted) {
                        ...
                        <div className="sticky top-24 space-y-6">
                            <div className="bg-white/5 border border-white/10 p-8 rounded-[40px] backdrop-blur-xl">
                                ...
                                <div className="pt-8 border-t border-white/10">
                                    ...
                                    {/* Quiz Badge - shows if quiz completed */}
                                    {quizCompleted && (
                                        <div className="mb-4 p-3 bg-purple-500/10 border border-purple-500/30 rounded-2xl flex items-center gap-3">
                                            <Brain className="w-5 h-5 text-purple-400" />
                                            <span className="text-sm text-purple-300">FanIQ Quiz Completed ✓</span>
                                        </div>
                                    )}
                                    ...
                                    >
                                        {isPending ? "Processing..." : quizCompleted ? "Complete Purchase" : "Purchase NFT Ticket"}
                                    </Button>
